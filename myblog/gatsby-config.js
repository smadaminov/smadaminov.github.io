module.exports = {
  ...
  plugins: [
    ...
    },
    {
      resolve: `gatsby-source-filesystem`,
      options: {
        path: `${__dirname}/content/mathclub`,
        name: `mathclub`,
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
      options: {
        path: `${__dirname}/content/research/publications`,
        name: `publications`,
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
      options: {
        path: `${__dirname}/content/research/service`,
        name: `service`,
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
      options: {
        path: `${__dirname}/content/research/teaching`,
        name: `teaching`,
      },
    },
    {
...
//        icon: `src/images/gatsby-icon.png`, // This path is relative to the root of the site.
        icon: `src/images/myface.jpg`, // This path is relative to the root of the site.
      },
    },
